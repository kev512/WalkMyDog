...
public class SearchEngineFragment extends Fragment {
    ...
    private SearchEngineViewModel mViewModel;

    public static SearchEngineFragment newInstance() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(SearchEngineViewModel.class);
